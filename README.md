...
- 预售商品可不受库存限制下单；秒杀商品走独立抢购流程，不参与优惠体系。
...
- 客服会话支持用户/客服自动收发、未读和最新分页、接待状态、附件、表情包和聊天记录搜索。
- 客服工单支持游客提交和后台处理。
...
- 订单、支付审核、优惠码、用户优惠码、售后、采购、仓库、库存、成本和报表。
