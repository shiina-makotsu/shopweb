...
Route::middleware(['auth', 'admin'])->prefix('admin/customers')->name('admin.customers.')->group(function (): void {
    Route::post('/{customer}/quick-update', [CustomerQuickUpdateController::class, 'update'])->name('quick-update');
});
