...
use App\Filament\Resources\QuantityUnitResource\Pages\ManageQuantityUnits;
...
class QuantityUnitResource extends Resource
{
    ...
    protected static ?string $navigationLabel = '数量单位';
    protected static ?string $modelLabel = '数量单位';
    protected static ?string $pluralModelLabel = '数量单位';
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            TextInput::make('precision')->label('小数位')->numeric()->default(0)->minValue(0)->maxValue(4),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('precision')->label('小数位')->sortable(),
    ...
    {
        return [
            'index' => ManageQuantityUnits::route('/'),
        ];
    }
}
