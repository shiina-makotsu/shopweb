<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="grid gap-6 xl:grid-cols-2">
            ...
            <x-report-table title="商品销售排行" :rows="$this->productSales()" :columns="['product' => '商品', 'sku' => 'SKU', 'quantity' => '数量', 'total' => '销售额']" :export-url="route('admin.report-exports.product-sales')" />
            <x-report-table title="分类销售排行" :rows="$this->categorySales()" :columns="['category' => '分类', 'items' => '订单商品数', 'quantity' => '数量', 'total' => '销售额']" :export-url="route('admin.report-exports.category-sales')" />
